...
% Bobbin: PCB1808B1
% Core: 0F41808EC
% 60 windings of 24 gauge, 8 windings of double 24 gauge


% Inductor Copper Properties
L_Rcopper = 13.3e-3;    % 18 AWG (page 103) (x2 for 2 24 gauge)
NL = 38;                % 24 turns of 18 gauge fit on 1 layer.
...
fprintf('%c = %f Wb\n',248,L_phi);
fprintf('B = %f T\n\n',L_B);
fprintf('Copper Loss: \n\tInductor = %f W\n\tTransformer = %f W\n',L_Pcopper,T_PcopperSec+T_PcopperPri);
fprintf('Core Loss: \n\tInductor = %f W\n\tTransformer = %f W\n',L_Pcore,T_Pcore);
fprintf('Total Loss: \n\tInductor = %f W\n\tTransformer = %f W\n',L_Pcore+L_Pcopper,T_PcopperSec+T_PcopperPri+T_Pcore);
fprintf('Diode Loss: \n\tDR = %f W\n\tDF = %f W\n',DR_Ploss, DF_Ploss);

Ploss = L_Pcopper + L_Pcore + T_PcopperSec + T_PcopperPri + T_Pcore + DR_Ploss + DF_Ploss;
Ptotal = Vout * Idc;
fprintf('Eff = %f \n',(Ptotal)/(Ptotal+Ploss));
